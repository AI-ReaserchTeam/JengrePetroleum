...
using JengrePetroleum.WebApi.JWT;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXafWebApi(builder => {
            ...
            builder.Modules
                ...
                .AddValidation()
                .Add<JengrePetroleum.Module.JengrePetroleumModule>();
            ...
            builder.AddBuildStep(application => {
                application.ApplicationName = "SetupApplication.JengrePetroleum";
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "JengrePetroleum API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the JengrePetroleum.WebApi\Startup.cs file to make Business Objects available in the Web API."
            });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "JengrePetroleum WebApi v1");
            });
        }
        else {

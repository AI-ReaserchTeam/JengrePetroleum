...
namespace JengrePetroleum.Module.BusinessObjects.Store.SpareParts
{
    ...
    public class SparePartStock : BaseObject
    {
        public SparePartStock(Session session) : base(session)
        {
        }
        ...
        public XPCollection<SparePartStockItem> StockItems
        {
            get
            {
                return GetCollection<SparePartStockItem>(nameof(StockItems));
            }
        }
